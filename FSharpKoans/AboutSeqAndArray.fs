            ...
            seq {
                ...
                | _ ->
                    let result =
                        ...
                        | 0 -> x/2
                        | _ -> 3*x+1
                    yield! hailstone result
                    // I'm giving back values taken from a sequence here
            }
        ...
        let rec puffery x =
           seq {
                ...
                | _ ->
                    ...
                    yield! puffery result // I'm giving back values taken from a sequence here
